...
{
    protected async Task<ActionResult<ViewModel>> ExecuteAsync(Func<Task> func)
    {
        await func();
    ...
    protected async Task<ActionResult<ViewModel<TResult>>> ExecuteAsync<TResult>(Func<Task<TResult>> func)
    {
